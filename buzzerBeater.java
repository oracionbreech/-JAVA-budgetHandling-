...
public class index {
	...
	public static void main(String[] args) {
	    ...
	    // ITEM LIST FOR JACKPOT 
	    
	    itemMbj[1].init("Diamond Necklace", 20000);
	    itemMbj[2].init("Watch", 5000);
	    itemMbj[3].init("Wine", 8000);
	    itemMbj[4].init("Bag", 10000);
	    itemMbj[5].init("Shoes", 9000);
	    itemMbj[6].init("Ring", 15000);
	    itemMbj[7].init("Clothes", 10000);
	    itemMbj[8].init("5 Star Hotel Accommodation", 18000);
	    itemMbj[9].init("Perfume", 11000);
	    itemMbj[10].init("Make Up", 17000);
	    
	    
	    itemMbj[1].init("Mobile Phone", 10000);
	    itemMbj[2].init("Gaming Credits", 9000);
	    itemMbj[3].init("Headset", 5000);
	    itemMbj[4].init("Microphone", 6000);
	    itemMbj[5].init("Speaker", 8000);
	    itemMbj[6].init("Keyboard & Mouse Set", 5500);
	    itemMbj[7].init("Graphic Tablet",9000);
	    itemMbj[8].init("Monitor", 6000);
	    itemMbj[9].init("Gaming Chair", 7000);
	    itemMbj[10].init("SSD Hard Disk", 9000);
	    // ITEM LIST FOR JACKPOT
	        ...
	        // Myster Box B
	            ...
	            System.out.println("Congratulations! You have won the Jackpot You Can Choose From Both Boxes");
	        	System.out.println("Mystery Box A and B");
				System.out.println(" ____________________________________________");
				System.out.println("|Item                           | Worth |");
				System.out.println("|_______________________________________|");
				System.out.println("|1. Diamond Necklace            |P20,000|");
				...
				System.out.println("|11. Mobile Phone            	|P10,000|");
				System.out.println("|12. Gaming Credits          	|P9,000 |");
				System.out.println("|13. Headset                 	|P5,000 |");
				System.out.println("|14. Speaker                 	|P8,000 |");
				System.out.println("|15. Keyboard & Mouse Set    	|P5,500 |");
				System.out.println("|16. Microphone              	|P6,000 |");
				System.out.println("|17. Graphic Tablet          	|P9,000 |");
				System.out.println("|18. Monitor                 	|P6,000 |");
				System.out.println("|19. Gaming Chair            	|P7,000 |");
				System.out.println("|20. SSD Hard Disk          	|P9,000 |");
				System.out.println("|_______________________________|_______|");
